...
class Transaction(models.Model):
    status_choices = ((1,'未支付'),(2,'已支付'),)

    status = models.SmallIntegerField(verbose_name='状态',choices=status_choices)
    order = models.CharField(verbose_name='订单号', max_length=64, unique=True)    # 建立索引
    ...
    count = models.IntegerField(verbose_name='',help_text='0表示无限期')
...
class Project(models.Model):
    COLOR_CHOICES = ((1,'#56b8eb'),(2,'#f28033'),(3,'#ebc656'),(4,'#a2d148'),(5,'#20bfa4'),(6,'#7461c2'),(7,'#20bfa3'),)
    ...
    create = models.ForeignKey(verbose_name='创建者',to='UserInfo', on_delete=models.DO_NOTHING)
    create_datetime = models.DateTimeField(verbose_name='创建时间',auto_now_add=True)
...
class Project_User(models.Model):
    ...
    # invatee = models.ForeignKey(verbose_name='参与者', to='UserInfo', related_name='b')
